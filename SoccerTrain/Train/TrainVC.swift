...
class TrainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        listData = [
            ...
            TrainModel(title: "传球训练", imageName: "pass", secondTitle: "Pass"),
            TrainModel(title: "运球训练", imageName: "dribbling", secondTitle: "Dribbling"),
            TrainModel(title: "射门训练", imageName: "shoot", secondTitle: "Shoot")
        ]
